...
const SpecialTredingSection = () => {
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center  md:h-full md:w-2/3   sm:h-full sm:w-2/3  bg-yellow-700">
        <div className="bg-gray-300 md:w-full md:h-11 sm:w-3/4 sm:h-11 w-full h-11 pl-3 flex items-center mt-1 rounded-lg border-2 border-gray-400">
          <img src={baidu} alt="" srcset="" />
          Treding Product
        </div>
        <div className="w-full md:w-full sm:w-full h-4/6 mt-5 grid md:grid-cols-3 sm:grid-cols-2 md:pl-5 md:gap-y-5 sm:pl-10 sm:gap-y-5  gap-y-5 bg-red-500">
